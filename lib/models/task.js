...
/**
 * ``Task.run()`` should be implemented and is used by the task registry when defining
 * available ``Gulp`` tasks. In this function you can use the ``this.options`` to access
 * ``Task`` internal options.
 */
...
/**
 * Expects that given argument is a function or throws an IllegalArgument exception
